...
public class InstructorDashboard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Instructor Mangement");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       CreateCourse create= new CreateCourse();
        ...
        parent.getContentPane().add(create);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       EditCourse edit= new EditCourse();
        JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(this);
        parent.getContentPane().removeAll();
        parent.getContentPane().add(edit);
        parent.getContentPane().revalidate();
        parent.getContentPane().repaint();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(this);
        parent.getContentPane().removeAll();
        parent.getContentPane().add(delete);
        parent.getContentPane().revalidate();
        parent.getContentPane().repaint();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(this);
        parent.getContentPane().removeAll();
        parent.getContentPane().add(add);
        parent.getContentPane().revalidate();
        parent.getContentPane().repaint();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        EditLesson editl= new EditLesson();
        JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(this);
        parent.getContentPane().removeAll();
        parent.getContentPane().add(editl);
        parent.getContentPane().revalidate();
        parent.getContentPane().repaint();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        DeleteLesson deletel= new DeleteLesson();
        JFrame parent = (JFrame) SwingUtilities.getWindowAncestor(this);
        parent.getContentPane().removeAll();
        parent.getContentPane().add(deletel);
        parent.getContentPane().revalidate();
        parent.getContentPane().repaint();
